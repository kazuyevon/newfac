		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<div class="btn-group-vertical">
				<div class="form-inline"> 
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
								<a class="dropdown-item" href="devtools/addclient.php">Ajouter des clients</a>
								<a class="dropdown-item" href="devtools/addfacture.php">Ajouter des factures</a>
								<a class="dropdown-item" href="#">Something else here</a>
					...
					<form class="my-2 my-lg-0 ml-auto" action="factures.php" method="get">
						<div class="btn-group" role="group" aria-label="Default button group">
							<input type="text" class="form-control typeahead" id="searchbox" name="searchbox" placeholder="Nom">
							<input type="hidden" name="idclient" id="searchboxid" value=""/>
							<input type="hidden" name="annee" id="searchboxannee" value="<?php echo date('Y') ?>"/>
